                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12" data-aos="fade-right" data-aos-duration="1000">
                                    <label class="form-label fs-1 fw-bold">Recent<i class="bi bi-cart-x fs-2"></i></label>
                                </div>
                                ...
                                <div class="col-12" data-aos="zoom-in" data-aos-duration="1000">
                                    <div class="row">
                                        ...
                                        <div class="offset-lg-2 col-12 col-lg-6 mb-3">
                                            <input type="text" class="form-control" placeholder="Search in Recent..." id="searchtxt" />
                                        </div>
                                        <div class="col-12 col-lg-2 mb-3 d-grid">
                                            <button class="btn btn-outline-warning" onclick="recentSearch();">Search</button>
                                        </div>
                                ...
                                <div class="col-11 col-lg-2 border-0 border-end border-1 border-warning" data-aos="fade-up-right" data-aos-duration="1000">
                                    ...
                                    <nav class="nav nav-pills flex-column">
                                        ...
                                        <a class="nav-link active bg-warning text-black" aria-current="page" href="recent.php">Recents</a>
                                    </nav>

                                </div>

                                <div class="col-12 col-lg-9" id="RecentSearchProducts">

                                    <?php

                                    $recent_rs = Database::search("SELECT * FROM `recent` WHERE `users_email`='" . $u . "'");
